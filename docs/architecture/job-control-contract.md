...
**Non-Linux POSIX (e.g., FreeBSD) — planned for Issue #18:**
...
FreeBSD full validation is tracked in Issue #18.
...
| #18 (FreeBSD) | Portability probes in place; full validation deferred |
